...
class FeedbackDataLoader {
    ...
    public function addProductsToFeedbackBySkus($feedback, $skus) {
        ...
        $products = $this->getProductsByField(self::PRODUCT_SKU_FIELD, $skus);
        $feedback->getExtensionAttributes()->setProducts($products);
    ...
    private function getProductsByField($field, $value) {
        // ('entity_id',  [0] => First Test Product
        ...
        $feedback = $this->productRepository->getList($searchCriteria)->getItems();
